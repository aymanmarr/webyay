...
export const Navbar = () => {
  ...
  return (
    <nav className="bg-background-lighter py-6 px-6 fixed w-full top-0 z-50">
  <div className="max-w-7xl mx-auto flex justify-between items-center">
    <Link to="/" className="flex items-center space-x-2">
      <img src={Logo} alt="SkyWings Logo" className="h-10 w-10 object-contain" />
    </Link>
  ...
  {isOpen && (
    <div className="md:hidden absolute top-16 left-0 right-0 bg-background-lighter py-6 px-6">
