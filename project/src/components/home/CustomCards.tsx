...
const CustomCards = () => {
  ...
  const cardClasses = [
    "w-[250px] h-[410px] top-[85px] left-[960px] z-10",
    "w-[200px] h-[300px] top-[150px] left-[1270px] z-10",
    "w-[200px] h-[300px] top-[150px] left-[700px] z-10",
    "w-[600px] h-[350px] top-[125px] left-[770px] z-0",
  ];
